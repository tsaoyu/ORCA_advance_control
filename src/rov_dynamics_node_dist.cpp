...
#include <ros/ros.h>
#include "ROVdynamicDisturbanceSim.h"
...
class DynamicSimulator{
    private:
        ...
        ros::Subscriber cmd_wrench_sub, disturbance_sub;
    ...
    public:
        ...
        DynamicSimulator(ros::NodeHandle *n){
            ...
            disturbance_sub = n->subscribe("/disturbance", 10, &DynamicSimulator::callback_disturbance, this);
        }
        ...
        void callback_disturbance(const geometry_msgs::Wrench::ConstPtr& msg){

...
#include "ROVdynamicDisturbance.h"
#include "configDir.h"
...
class MPCController {
    ...
    public:
        ...
        void disturbance_message_converter(const geometry_msgs::Wrench::ConstPtr& msg,
        ...
        void disturbance_callback(const geometry_msgs::Wrench::ConstPtr& msg){
            if (first_pass_) {
                return;
            }

            MPCController::disturbance_message_converter(msg, this->x_now);
            MPCController::disturbance_message_converter(msg, this->x_ref);
        }
        ...
        void publish_cmd_wrench(){
            ...
            // std::cout << "Current state: "<< this -> x_now << std::endl;
            // std::cout << "Reference state: "<< this -> x_ref << std::endl;
        ...
        private:
            ros::Subscriber pose_ref_sub, odom_sub, disturbance_sub;

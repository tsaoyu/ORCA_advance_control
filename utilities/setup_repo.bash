...
git clone git@github.com:tsaoyu/ORCA_advance_control.git ~/Playground/ct_ws/src/ORCA_advance_control/
git clone --bare ~/Playground/ct_ws/src/ORCA_advance_control/ orca-bluerov-advance-bare
cd ~/Playground/ct_ws/src/ORCA_advance_control/
